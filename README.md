...
The project models the backend for an Uber-style ride-sharing platform. It includes separate services for API access, trip orchestration, driver workflows, and supporting infrastructure, with asynchronous communication handled through RabbitMQ.

The goal of this repo is to demonstrate practical microservice design: containerized services, Kubernetes manifests for local and production environments, message-driven workflows, and a development loop powered by Tilt.
